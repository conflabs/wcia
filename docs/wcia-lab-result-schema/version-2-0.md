---
slug: version-2-0
title: WCIA Lab Result Schema - v2.0
...
* Lab Result Schema Object [labResultSchema.json](./assets/v-2-0-lab-result-schema.json)
* Example of a Complete Result [example.json](./assets/v-2-0-example.json)
